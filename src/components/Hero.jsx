...
const Hero = () => {
  return (
    <section
      className="relative bg-cover bg-center h-[800px] sm:h-[600px] md:h-[900px] w-full" // Adjusted height and full width
      style={{ backgroundImage: 'url(https://t3.ftcdn.net/jpg/06/04/35/80/360_F_604358069_yVuu2zQ6w9EpMANISlXUgMuA9kAr5X5C.jpg)' }} 
    >
